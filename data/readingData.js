 ...
 * Updated with official Cambridge IELTS book answer keys.
 */
    ...
    "passages": [
      {
        ...
        "questions": [
          {
            "type": "tfng",
            "instruction": "Questions 1-7: Do the following statements agree with the information given in Reading Passage 1?\nIn boxes 1-7 on your answer sheet, write:\nTRUE if the statement agrees with the information\nFALSE if the statement contradicts the information\nNOT GIVEN if there is no information on this",
            "items": [
              {
                "num": 1,
          ...
          {
            "type": "fill",
            "instruction": "Questions 8-13: Complete the notes below.\nChoose ONE WORD ONLY from the passage for each answer.",
            "items": [
              {
                "num": 8,
                "label": "Mike and Bob Bryan made changes to the types of ____ used on their racket frames.",
                "answer": "paint"
              },
              {
                "num": 9,
                "label": "Players were not allowed to use the spaghetti-strung racket because of the amount of ____ it created.",
                "answer": "topspin"
              },
              {
                "num": 10,
                "label": "Changes to rackets can be regarded as being as important as players' diets or the ____ they do.",
                "answer": "training"
              },
              {
                "num": 11,
                "label": "All rackets used to have natural strings made from the ____ of animals.",
                "answer": "intestines / gut"
              },
              {
                "num": 12,
                "label": "Pete Sampras had metal ____ put into the frames of his rackets.",
                "answer": "weights"
              },
              {
                "num": 13,
                "label": "Gonçalo Oliveira changed the ____ on his racket handles.",
                "answer": "grips"
              }
            ]
          }
      ...
      },
      {
        ...
        "questions": [
          ...
          {
            "type": "fill",
            "instruction": "Questions 31-36: Complete the summary using the list of phrases, A-J, below.\nA constant conflict   B additional evidence   C different locations\nD experimental subjects E short period          F extreme distrust\nG frequent exposure   H mental operation      I dubious reason\nJ different ideas",
            "items": [
              {
                "num": 31,
                "label": "What happens when people encounter misinformation?\nAlthough people have ____ to misinformation",
                "answer": "G"
              },
              {
                "num": 32,
                "label": "there is debate about precisely how and when we label something as true or untrue. The philosophers Descartes and Spinoza had ____ about how people engage with information.",
                "answer": "J"
              },
              {
                "num": 33,
                "label": "While Descartes believed that people accept or reject information after considering whether it is true or not, Spinoza argued that people accepted all information they encountered (and by default misinformation) and did not verify or reject it until afterwards. Moreover, Spinoza believed that a distinct ____ is involved in these stages.",
                "answer": "H"
              },
              {
                "num": 34,
                "label": "Recent research has provided ____ for Spinoza's theory",
                "answer": "B"
              },
              {
                "num": 35,
                "label": "and it would appear that people accept all encountered information as if it were true, even if this is for an extremely ____",
                "answer": "E"
              },
              {
                "num": 36,
                "label": "and do not label the information as true or false until later. This is consistent with the fact that the resources for scepticism and the resources for perceiving and encoding are in ____ in the brain.",
                "answer": "C"
              }
            ]
          },
          {
            "type": "tfng",
            "instruction": "Questions 37-40: Do the following statements agree with the claims of the writer in Reading Passage 3?\nYES if the statement agrees with the claims of the writer\nNO if the statement contradicts the claims of the writer\nNOT GIVEN if it is impossible to say what the writer thinks about this",
            "items": [
              {
                "num": 37,
